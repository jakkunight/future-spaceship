...
export default function Display({ children, ...props }: DisplayParams) {
  return <div
    className="text-cyan-200 text-4xl shadow-[inset_0px_0px_2rem] shadow-cyan-500 bg-[100% 80%] bg-repeat-y bg-gradient-to-b from-transparent via-cyan-900/50 via-50% animate-oldcrt w-screen h-screen" {...props}>
    <div
